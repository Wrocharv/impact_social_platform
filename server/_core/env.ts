...
export const ENV = {
  ...
  mercadoPagoAccessToken: process.env.MERCADO_PAGO_ACCESS_TOKEN ?? process.env.MERCADOPAGO_ACCESS_TOKEN ?? "",
  mercadoPagoWebhookSecret: process.env.MERCADO_PAGO_WEBHOOK_SECRET ?? process.env.MERCADOPAGO_WEBHOOK_SECRET ?? "",
