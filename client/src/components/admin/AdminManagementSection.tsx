  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-2xl font-bold text-[#243128]">Administradores</h2>
          <p className="mt-1 text-[#66736a]">Adicione ou remova pessoas com acesso ao painel — total ou só de algumas áreas.</p>
        </div>
