...
export const campaigns = mysqlTable("campaigns", {
  ...
  helpTierOptions: varchar("helpTierOptions", { length: 64 }).default("material,financial,vip").notNull(),
...
export const contributions = mysqlTable("contributions", {
  ...
  donorBirthDate: date("donorBirthDate"),
  donorGender: mysqlEnum("donorGender", ["male", "female", "other", "prefer_not_to_say"]),
...
/**
 * Credenciais de administrador (login com e-mail e senha, independente do fluxo OAuth).
 */
